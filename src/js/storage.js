...
function item(imgurl,i){
	var itemHtml='<div class="itemsDiv"><div class="item"><img src = '+imgurl+' id="history_'+i+'"/><a href="javascript:void(0);" id="history_del_'+i+'">删除</a><a href="'+imgurl+'" id="history_download_'+i+'" download="picture.png">下载</a></div></div>';
